...
const navigation = {
    ...
    community: [
        ...
        { name: 'Support refugees', href: '/refugees' },
    ...
    hosting: [
        ...
        { name: 'Visit our community forum', href: '/community' },
    ],
};
            ...
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div className="space-y-8 xl:col-span-1">
                        <div className="text-2xl font-bold text-blue-600">
                            Booking<span className="text-blue-400">App</span>
                        </div>
                        <p className="text-gray-500 text-base">
                            Find the perfect place to stay at an amazing price in 191+ countries. Belong anywhere with BookingApp.
                        </p>
                            ...
                            <div>
                                ...
                                <ul role="list" className="mt-4 space-y-4">
                                    {navigation.support.map((item) => (
                                        <li key={item.name}>
                                            <Link to={item.href} className="text-base text-gray-500 hover:text-blue-600">
                                                {item.name}
                                            </Link>
                                        </li>
                                    ))}
                ...
                <div className="mt-12 border-t border-gray-200 pt-8">
                    <p className="text-base text-gray-400 text-center">
                        &copy; {new Date().getFullYear()} BookingApp, Inc. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
